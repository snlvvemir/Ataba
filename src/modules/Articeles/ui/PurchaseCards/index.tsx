...
import TimerIcon from '@/components/img/svg/Timer.svg'
import UsersIcon from '@/components/img/svg/Users.svg'
    ...
    <div className={style.card}>
        ...
        <div className={style.TimerWrapper}>
            <div className={style.TimerIcon}>
                <Image fill src={TimerIcon} alt=''/>
            </div>
            <span className={style.TimerText}>04:59:12</span>
        </div>
            ...
            <div className={style.bottomCard}>
                <div className={style.rating}>
                    <div className={style.StarIcon}>
                        <Image fill src={UsersIcon} alt=''/>
                    </div>
                    <span className={style.RatingText}>{users}</span>
                </div>
            </div>
        </div>
    </div>
